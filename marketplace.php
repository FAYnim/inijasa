...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-marketplace sticky-top py-3">
        <div class="container">
            <a class="navbar-brand" href="marketplace.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <?php if (isLoggedIn()): ?>
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="dashboard.php">Dashboard</a>
                        </li>
                        <li class="nav-item ms-3">
                            <a class="btn btn-login-outline" href="auth/logout.php">Logout</a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="auth/login.php">Masuk Bisnis</a>
                        </li>
                        <li class="nav-item ms-3">
                            <a class="btn btn-login-outline" href="auth/register.php">Daftar</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <form action="marketplace.php" method="GET" class="search-container mt-4">
    ...
    <section class="catalog-section container">
        <?php if (!empty($searchQuery)): ?>
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="marketplace.php" class="text-decoration-none text-muted"><i class="fas fa-times me-1"></i>Reset</a>
            </div>
        <?php else: ?>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <?php if (!empty($searchQuery)): ?>
                    <a href="marketplace.php" class="btn btn-login-outline mt-3">Lihat Semua Jasa</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </section>

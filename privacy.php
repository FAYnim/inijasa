...
<head>
    ...
    <title>Kebijakan Privasi - Jasaku</title>
    ...
    <section class="py-5 bg-light my-5">
        <div class="container px-4 px-lg-5 py-3">
            <div class="bg-white p-4 p-md-5 rounded-4 shadow-sm">
                ...
                <p class="text-muted mb-4">Informasi Anda digunakan untuk menyediakan, menjaga, dan meningkatkan fungsionalitas layanan Jasaku serta untuk memberikan pembaruan platform.</p>
                ...
                <p class="text-muted mb-0">Anda berhak untuk mengakses, mengedit, atau menghapus data pribadi Anda kapan pun Anda menginginkannya dalam pengaturan akun Jasaku.</p>
            </div>
        </div>
    </section>

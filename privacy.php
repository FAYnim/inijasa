...
<head>
    ...
    <title>Kebijakan Privasi - IniJasa</title>
    ...
    <section class="py-5 bg-light my-5">
        <div class="container px-4 px-lg-5 py-3">
            <div class="bg-white p-4 p-md-5 rounded-4 shadow-sm">
                <h4 class="fw-bold mb-3">1. Pengumpulan Data</h4>
                <p class="text-muted mb-4">Kami mengumpulkan informasi yang Anda berikan saat mendaftar, menggunakan layanan kami, dan berkomunikasi dengan dukungan kami.</p>

                <h4 class="fw-bold mb-3">2. Penggunaan Data</h4>
                <p class="text-muted mb-4">Informasi Anda digunakan untuk menyediakan, menjaga, dan meningkatkan fungsionalitas layanan IniJasa serta untuk memberikan pembaruan platform.</p>

                <h4 class="fw-bold mb-3">3. Keamanan Data</h4>
                <p class="text-muted mb-4">Kami menerapkan praktik standar industri terbaik untuk melindungi data pribadi dan finansial Anda dari akses yang tidak sah.</p>

                <h4 class="fw-bold mb-3">4. Hak Pengguna</h4>
                <p class="text-muted mb-0">Anda berhak untuk mengakses, mengedit, atau menghapus data pribadi Anda kapan pun Anda menginginkannya dalam pengaturan akun IniJasa.</p>
            </div>
        </div>
    </section>
